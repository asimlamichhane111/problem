...
from .views import  low_stock_products, product_list, top_selling_products, update_product
...
urlpatterns=[
    ...
    path('api/top-selling/', top_selling_products, name='top-selling-products'),
